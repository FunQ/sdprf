...
class SSP {
	 ...
	 *
	 *  @param  mixed $con SQL connection details. The array should have
	 ...
	 *
	 *  @param  array $request Data sent to server by DataTables
	 *  @param  array|PDO $con PDO connection resource or connection parameters array
