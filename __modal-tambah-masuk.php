<div class="modal fade" id="formTambahMasuk">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control tanggal" name="tanggal" id="tanggal" readonly><br />
                    <select name="listBarang" id="listBarang" class="form-control">
                        <?php foreach($arrBrgMasuk as $barang){ ?>
                ...
                <div class="form-group" style="width: 200%">
                    <button type="button" class="shadow btn btn-success buttonload" id="btnAddToList" onclick="inputToList('masuk')">
                        Tambah Barang <i id="spinnerAddToList"></i>
                    </button>
                    <button type="button" class="shadow btn btn-primary ml-1 buttonload" id="btnAddIn" onclick="inputToDBMasuk()">
                        Kirim <i id="spinnerAdd"></i>
                    </button>
                    <button type="button" class="shadow btn btn-danger ml-1 buttonload" id="btnReset" onclick="resetInput()">
                        Reset Inputan <i id="spinnerReset"></i>
                    </button>
